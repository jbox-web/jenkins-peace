...
module Jenkins
  module Peace
    class CLI < Thor
      ...
      desc 'install <version>',
           'Install war file corresponding to version passed in params (will download then unpack war file)'
      ...
      method_option :home,    aliases: '-h', default: File.join(Dir.home, '.jenkins', 'server'), type: :string,
                              desc: 'Use this directory to store server data'
      method_option :port,    aliases: '-p', default: 3001,  type: :numeric, desc: 'Port for server (default 3001)'
      method_option :control, aliases: '-c', default: 3002,  type: :numeric,
                              desc: 'Shutdown/Control port (default 3002)'
      ...
      method_option :logfile, aliases: '-l', default: File.join(Dir.pwd, 'jenkins.log'), type: :string,
                              desc: 'Redirect log messages to this file'
